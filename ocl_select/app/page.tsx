    ...
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 tracking-tight">
            Trip Registration
          </h1>
          <p className="text-base sm:text-lg lg:text-xl text-gray-500 dark:text-gray-400 font-light">
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 sticky top-8">
              <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-white mb-6 sm:mb-8">
                Student Information
              </h2>

              {message && (
                <div
                  className={`mb-6 sm:mb-8 px-4 sm:px-5 py-3 sm:py-4 rounded-xl sm:rounded-2xl text-sm ${
          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10">
                    ...
                    className={`
                      ...
                      ${
                        city.remaining === 0
                          ...
                          : "bg-white dark:bg-black border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-md active:scale-[0.98]"
                      }
                    `}
                  >
